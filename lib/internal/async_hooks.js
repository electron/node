...
/**
 * Because some modules (*cough* natives *cough*) try to use node internals
 * they sometimes hit this module which CAN ONLY BE LOADED ONCE.
 * 
 * We use this code because hitting this case is more likely in Electron due
 * to graceful-fs and our wrapping of the "fs" module.  This code simply
 * caches the result of the first load in a global process var and then uses
 * it on subsequent requires.
 */
if (process._cachedAsyncHooks) {
  module.exports = process._cachedAsyncHooks;
  return;
}
process._cachedAsyncHooks = module.exports;
